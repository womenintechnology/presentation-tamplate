...
(function (root, factory) {
    ...
    function loadScript(url, callback) {
        ...
        if (callback) {
            ...
            script.onerror = function (err) {
                ...
                callback(
                    new Error(
                        "Failed loading script: " + script.src + "\n" + err
                    )
                );
            };
        }
            ...
            function (slide) {
                ...
                if (slide.classList.contains("stack") === false) {
                    ...
                    if (doingSlideNumbers) {
                        ...
                        numberElement.innerHTML = slide.getAttribute(
                            "data-slide-number"
                        );
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                var result = Reveal[data.method].apply(
                                    Reveal,
                                    data.args
                                );
    ...
    function configure(options) {
        ...
        var numberOfSlides = dom.wrapper.querySelectorAll(SLIDES_SELECTOR)
            .length;
    ...
    function enablePreviewLinks(selector) {
        var anchors = toArray(
            document.querySelectorAll(selector ? selector : "a")
        );
    ...
    function deactivateOverview() {
        ...
        if (config.overview) {
            ...
            toArray(
                dom.background.querySelectorAll(".slide-background")
    ...
    function hasNotes() {
        return (
            dom.slides.querySelectorAll("[data-notes], aside.notes").length > 0
        );
    }
    ...
    function updateBackground(includeAll) {
        ...
        toArray(dom.background.childNodes).forEach(function (backgroundh, h) {
            ...
            if (includeAll || h === indexh) {
                toArray(
                    backgroundh.querySelectorAll(".slide-background")
    ...
    function loadSlide(slide, options) {
        ...
        toArray(slide.querySelectorAll("video, audio")).forEach(function (
            media
        ) {
            var sources = 0;
    ...
    function unloadSlide(slide) {
        ...
        if (background) {
            ...
            toArray(background.querySelectorAll("iframe[src]")).forEach(
                function (element) {
    ...
    function startEmbeddedContent(element) {
        if (element && !isSpeakerNotes()) {
            ...
            // Normal iframes
            toArray(element.querySelectorAll("iframe[src]")).forEach(function (
                el
            ) {
                if (
                    closestParent(el, ".fragment") &&
    ...
    function getIndices(slide) {
        ...
        if (slide) {
            ...
            if (isVertical) {
                v = Math.max(
                    toArray(
                        slide.parentNode.querySelectorAll("section")
                    ).indexOf(slide),
                    0
                );
            }
